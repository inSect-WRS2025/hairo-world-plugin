...
#ifndef CNOID_BODY_EDIT_PLUGIN_BODY_CREATOR_DIALOG_H
#define CNOID_BODY_EDIT_PLUGIN_BODY_CREATOR_DIALOG_H
...
#endif // CNOID_BODY_EDIT_PLUGIN_BODY_CREATOR_DIALOG_H